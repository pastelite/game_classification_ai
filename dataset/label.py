...
games_list = [
    ...
    "VALORANT",  # 0
    "Counter-Strike: Global_Offensive",  # 1, Twitch combines 2 games into 1 despite being different enough
    "Counter-Strike 2",  # 2
    "Overwatch 2",  # 3
...
# Game Enum (I need to create new array for this)
GameLabel = Enum(
    "Game",
    [
        "VALORANT",
...
if __name__ == "__main__":
    ...
    assert len(GameLabel) == 30
    assert GameLabel.Apex_Legends.value == 6
